...
const TeamStatDists = ({season, statsAll}) => {
    ...
    return <div>
        ...
        <h1>Team Stat Distributions <NewWindowLink /></h1>
        <p>More: <a href={helpers.leagueUrl(['team_stats', season])}>Main Stats</a> | <a href={helpers.leagueUrl(['team_shot_locations', season])}>Shot Locations</a></p>
