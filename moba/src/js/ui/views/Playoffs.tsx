...
Playoffs.propTypes = {
    confNames: PropTypes.arrayOf(PropTypes.string).isRequired,
		NAConference: PropTypes.bool.isRequired,
		EUConference: PropTypes.bool.isRequired,
		LCSConference: PropTypes.bool.isRequired,
		LCSExtended: PropTypes.bool.isRequired,
		LCKConference: PropTypes.bool.isRequired,
		LPLConference: PropTypes.bool.isRequired,
		LMSConference: PropTypes.bool.isRequired,
		WorldsPlayoff: PropTypes.bool.isRequired,
		WorldsRegionals: PropTypes.bool.isRequired,
		WorldsGroups: PropTypes.bool.isRequired,
		WorldsSpring: PropTypes.bool.isRequired,
		WorldsSummer: PropTypes.bool.isRequired,
		LadderExtended: PropTypes.bool.isRequired,
		LadderExtendedMax: PropTypes.bool.isRequired,
		NALCSWorlds: PropTypes.bool.isRequired,
		EULCSWorlds: PropTypes.bool.isRequired,
		naLadder: PropTypes.bool.isRequired,
		euLadder: PropTypes.bool.isRequired,
		lckLadder: PropTypes.bool.isRequired,
		lplLadder: PropTypes.bool.isRequired,
		lmsLadder: PropTypes.bool.isRequired,
		wcLadder: PropTypes.bool.isRequired,
		worlds2019: PropTypes.bool.isRequired,
		vietnam: PropTypes.bool.isRequired,
		sea: PropTypes.bool.isRequired,
		brazil: PropTypes.bool.isRequired,
		cis: PropTypes.bool.isRequired,
		japan: PropTypes.bool.isRequired,
		latin: PropTypes.bool.isRequired,
		oce: PropTypes.bool.isRequired,
		turkey: PropTypes.bool.isRequired,
		groups1: PropTypes.bool.isRequired,
		playoff1: PropTypes.bool.isRequired,
		groups2: PropTypes.bool.isRequired,
		playoff2: PropTypes.bool.isRequired,
  ...
  //  numPlayoffRounds: PropTypes.number.isRequired,
	...
	playoffsTypeSummer: PropTypes.string.isRequired
};
