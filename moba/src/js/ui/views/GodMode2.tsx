...
GodMode.propTypes = {
    ...
    realChampNames: PropTypes.bool.isRequired,
    standardBackground: PropTypes.bool.isRequired,

    regionalRestrictions: PropTypes.bool.isRequired,
    alwaysKeep: PropTypes.bool.isRequired,


    refuseToLeave: PropTypes.bool.isRequired,
    refuseToSign: PropTypes.bool.isRequired,

    retirementPlayers: PropTypes.bool.isRequired,
    yearPositionChange: PropTypes.bool.isRequired,

    applyToCoachMode: PropTypes.bool.isRequired,
	aiPickBanStrength: PropTypes.number.isRequired,
    ...
    customRosterModeStrength: PropTypes.number.isRequired,


    numGames: PropTypes.number.isRequired,
    coachTOP: PropTypes.number.isRequired,
	coachJGL: PropTypes.number.isRequired,
	coachMID: PropTypes.number.isRequired,
	coachADC: PropTypes.number.isRequired,
	coachSUP: PropTypes.number.isRequired,
    coachTOPjgl: PropTypes.number.isRequired,
	coachJGLjgl: PropTypes.number.isRequired,
	coachMIDjgl: PropTypes.number.isRequired,
	coachADCjgl: PropTypes.number.isRequired,
	coachSUPjgl: PropTypes.number.isRequired,
    ...
    customRosterMode: PropTypes.bool.isRequired,
	...
	prospectSupply: PropTypes.number.isRequired,

	ratioEU: PropTypes.number.isRequired,

	ratioNA: PropTypes.number.isRequired,
	ratioCN: PropTypes.number.isRequired,
	ratioTW: PropTypes.number.isRequired,
	ratioOCE: PropTypes.number.isRequired,
	ratioBR: PropTypes.number.isRequired,
	ratioSEA: PropTypes.number.isRequired,
	ratioJP: PropTypes.number.isRequired,
	ratioCIS: PropTypes.number.isRequired,
	ratioLatAm: PropTypes.number.isRequired,




	germanRatio: PropTypes.number.isRequired,
	koreanRatio: PropTypes.number.isRequired,



	playoffWins: PropTypes.number.isRequired,

	masterGameSimAdjuster: PropTypes.number.isRequired,
	femaleOdds: PropTypes.number.isRequired,
