...
Playoffs2.propTypes = {
    confNames: PropTypes.arrayOf(PropTypes.string).isRequired,
		...
		NAWorlds: PropTypes.bool.isRequired,
		EUWorlds: PropTypes.bool.isRequired,
		CSPromo3: PropTypes.bool.isRequired,
		CSPromo2: PropTypes.bool.isRequired,
		LadderExtended: PropTypes.bool.isRequired,
		LadderExtendedMax: PropTypes.bool.isRequired,
		WorldsPlayIn: PropTypes.bool.isRequired,
		WorldsGroupPlay: PropTypes.bool.isRequired,
		WorldsGroupKnockout: PropTypes.bool.isRequired,
		WorldsGroupFinals: PropTypes.bool.isRequired,
