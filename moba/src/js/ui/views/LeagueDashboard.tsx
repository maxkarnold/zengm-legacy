...
LeagueDashboard.propTypes = {
    ...
    fgRank: PropTypes.number.isRequired,
    fgaRank: PropTypes.number.isRequired,
    fgp: PropTypes.number.isRequired,
    fgpRank: PropTypes.number.isRequired,
    leagueLeaders: PropTypes.object.isRequired,
    lost: PropTypes.number.isRequired,
    lostSpring: PropTypes.number.isRequired,
    lostSummer: PropTypes.number.isRequired,
    ...
    tpRank: PropTypes.number.isRequired,
    upcoming: PropTypes.arrayOf(PropTypes.object).isRequired,
    won: PropTypes.number.isRequired,
    wonSpring: PropTypes.number.isRequired,
    wonSummer: PropTypes.number.isRequired,
};
