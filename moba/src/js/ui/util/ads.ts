        ...
        return new Promise(resolve => {
            window.googletag.cmd.push(() => {
                gptAdSlots[0] = window.googletag
                    .defineSlot('/42283434/BBGM_Top', [[970, 90], [728, 90], [970, 250]], 'div-gpt-ad-1491369323599-3')
                    .addService(window.googletag.pubads());
                gptAdSlots[1] = window.googletag
                    .defineSlot('/42283434/BBGM_Square_Left', [[300, 250], [336, 280]], 'div-gpt-ad-1491369323599-1')
                    .addService(window.googletag.pubads());
                gptAdSlots[2] = window.googletag
                    .defineSlot('/42283434/BBGM_Square_Right', [[300, 250], [336, 280]], 'div-gpt-ad-1491369323599-2')
                    .addService(window.googletag.pubads());
